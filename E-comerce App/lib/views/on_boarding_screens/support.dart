        ...
        return SafeArea(
          ...
          child: Scaffold(
            floatingActionButton: GestureDetector(
                onTap: () {
                  model.navigationService.navigateToReplacement(to: VendorHomeScreen());
                },
                child: Stack(
      ...
      builder: (context, model, child) {
        return SafeArea(
          ...
          child: Scaffold(
            floatingActionButton: GestureDetector(
              onTap: (){
                Navigator.push(context, PageTransition(type: PageTransitionType.fade, child:  VendorHomeScreen()));
              },
                child: Stack(
                  alignment: Alignment.center,
                  children: [
