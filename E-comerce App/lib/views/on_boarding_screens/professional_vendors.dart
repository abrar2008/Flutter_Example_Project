...
import 'package:hazrin/views/on_boarding_screens/location.dart';
import 'package:page_transition/page_transition.dart';
import 'package:stacked/stacked.dart';

class ProfessionalVendors extends StatefulWidget {
  const ProfessionalVendors({Key? key}) : super(key: key);

  @override
  _ProfessionalVendorsState createState() => _ProfessionalVendorsState();
}

class _ProfessionalVendorsState extends State<ProfessionalVendors>
        ...
        return SafeArea(
          ...
          child: Scaffold(
            floatingActionButton: GestureDetector(
                onTap: () {
                  model.navigationService.navigateTo(to: Location());
                  //Navigator.push(context, PageTransition(type: PageTransitionType.fade, child: Location()));
                },
                child: Stack(
